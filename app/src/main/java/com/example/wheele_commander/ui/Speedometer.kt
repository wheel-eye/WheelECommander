...
class Speedometer @JvmOverloads constructor(
    ...
    private fun renderMinorTicks(canvas: Canvas) {
        for (s in MIN_SPEED..maxSpeed step MINOR_TICK_STEP) {
            if (s % 10 != 0) {
                canvas.drawLine(
    ...
    private fun renderMajorTicks(canvas: Canvas) {
        for (s in MIN_SPEED..maxSpeed step MAJOR_TICK_STEP) {
            canvas.drawLine(
    ...
    companion object {
        ...
        private const val MINOR_TICK_STEP = 1
        private const val MAJOR_TICK_STEP = 2
        private const val TICK_MARGIN = 10f
        private const val TICK_TEXT_MARGIN = 30f
        private const val MAJOR_TICK_SIZE = 50f
        private const val MINOR_TICK_SIZE = 30f
        private const val MAJOR_TICK_WIDTH = 8f
        private const val MINOR_TICK_WIDTH = 4f
    }
}